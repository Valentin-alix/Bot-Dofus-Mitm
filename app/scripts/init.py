...
from app.scripts.dofus_unpack.d2i_unpack import d2i_unpack
from app.scripts.dofus_unpack.d2o_unpack import d2o_unpack
from app.scripts.generate_python_class import launch_generator
from app.scripts.init_bdd import init_bdd
...
if __name__ == "__main__":
    ...
    # d2p_unpack(
    #     os.environ.get("D2P_FOLDER"),
    #     output_folder=os.path.join(resources_path, "from_d2p"),
    # )
    init_bdd()
