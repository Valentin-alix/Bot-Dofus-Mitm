...
function display_item(items)
{
    for (let item of items)
    {
        ...
        <td><button class="btn btn-danger" onclick="delete_item('${item[0].replace("'", "\\'")}')"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
