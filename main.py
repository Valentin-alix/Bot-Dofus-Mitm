...
async def main_fm():
    ...
    ui = Ui(queue_target_item, queue_inserted_item, queue_actual_item, event_is_playing)
    await ui.window()
    sniffer = Sniffer(event_ready, queue_actual_item, queue_inserted_item, event_is_playing)
    bot_fm = BotFM("Ezrealeeuu", queue_target_item, queue_actual_item, event_ready, event_is_playing)
